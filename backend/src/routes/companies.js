...
router.get('/', async (req, res) => {
  try {
    const [rows] = await db.query('SELECT id, user_id, company_name, company_email, company_phone, company_gst, company_address, industry, logo, created_by, payment_terms FROM companies');
    res.json(rows);
  } catch (err) {
