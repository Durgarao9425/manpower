...
// export const ButtonDeliveryLoader = ({
//   loading = false,
//   children,
//   variant = "delivery",
//   className = "",
...
// }) => {
//   const getIcon = () => {
//     const iconStyle = { fontSize: 18, animation: 'pulse 1.5s infinite' };

//     switch (variant) {
//       case 'bike':
//         return <TwoWheelerIcon style={iconStyle} />;
//       case 'truck':
//         return <LocalShippingIcon style={iconStyle} />;
//       case 'package':
//         return <InventoryIcon style={iconStyle} />;
//       default:
//         return <ShoppingBagIcon style={iconStyle} />;
//     }
//   };
