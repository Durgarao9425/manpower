...
const themeColors = {
  primary: "#4F46E5",        // Primary accent color (purple) used for buttons, highlights
  secondary: "#6B7280",      // Secondary text or icons (neutral gray)
  background: "#FFFFFF",     // Main application background (white)
  cardBg: "#F9FAFB",         // Card or section background (light grayish)
  sidebarBg: "#FFFFFF",      // Sidebar background (white to match overall theme)
  textPrimary: "#111827",    // Main text color (dark gray for high readability)
  textSecondary: "#6B7280",  // Secondary text color (subdued gray)
  borderColor: "#E5E7EB",    // Border and divider color (light gray)
  success: "#10B981",        // Success messages or status (green)
  warning: "#F59E0B",        // Warning messages or status (amber)
  error: "#EF4444",          // Error messages or status (red)
  highlight: "#4F46E5",      // Used for highlighting active links or items
  hoverBg: "#F3F4F6",        // Background on hover state (light gray)
};
    ...
    >
      ...
      >
        <Toolbar sx={{ 
          ...
          <IconButton sx={{ color: themeColors.secondary }}>
            <SettingsIcon />
          </IconButton>
        </Toolbar>
      </AppBar>
