...
const InvoiceListPage = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'Overdue': return { color: '#d32f2f', bg: '#ffebee' };
      case 'Pending': return { color: '#ed6c02', bg: '#fff3e0' };
      case 'Draft': return { color: '#757575', bg: '#f5f5f5' };
      default: return { color: '#1976d2', bg: '#e3f2fd' };
    }
  };
...
Due Date: ${selectedInvoice.dueDate}
    ...
    setSnackbar({
      open: true,
      message: `Invoice ${selectedInvoice.invoiceNumber} downloaded successfully`,
      severity: 'success'
    });
    handleMenuClose();
  };
          ...
          <CardContent sx={{ p: 4 }}>
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} md={6}>
                ...
                <Typography variant="body2">{selectedInvoice?.customer}</Typography>
                <Typography variant="body2" color="text.secondary">
            ...
            <Box sx={{ mt: 4, p: 2, bgcolor: '#f5f5f5', borderRadius: 1 }}>
              <Typography variant="body2" color="text.secondary">
                <strong>Notes:</strong> We appreciate your business. Should you need us to add VAT or extra notes let us know!
              </Typography>
            </Box>
          </CardContent>
        </Card>
    ...
    <Box sx={{ p: 3, bgcolor: '#f8f9fa', minHeight: '100vh' }}>
          ...
          >
            {tabs.map((tab, index) => (
              <Tab
                ...
                sx={{
                  bgcolor: activeTab === index ? `${tab.color}15` : 'transparent',
                  color: activeTab === index ? tab.color : '#666',
                  border: activeTab === index ? `2px solid ${tab.color}` : '2px solid transparent'
                }}
              />
            ))}
          </Tabs>
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ bgcolor: '#f8f9fa' }}>
                <TableCell sx={{ fontWeight: 'bold', color: '#2c3e50' }}>Customer</TableCell>
                <TableCell sx={{ fontWeight: 'bold', color: '#2c3e50' }}>Create</TableCell>
                <TableCell sx={{ fontWeight: 'bold', color: '#2c3e50' }}>Due</TableCell>
                <TableCell sx={{ fontWeight: 'bold', color: '#2c3e50' }}>Amount</TableCell>
                <TableCell sx={{ fontWeight: 'bold', color: '#2c3e50' }}>Sent</TableCell>
            ...
            <TableBody>
              {filteredInvoices.map((invoice) => (
                ...
                >
                  ...
                  <TableCell>
                    <Typography variant="body2" fontWeight="500">{invoice.createDate}</Typography>
                    <Typography variant="caption" color="text.secondary">11:33 pm</Typography>
                  </TableCell>
                  <TableCell>
                    <Typography variant="body2" fontWeight="500">{invoice.dueDate}</Typography>
                  ...
                  <TableCell>
                    <Chip
                      ...
                      sx={{
                        ...
                        fontWeight: 'bold',
                        border: `1px solid ${getStatusColor(invoice.status).color}`,
                        '&:hover': {
      ...
      <Dialog open={openGenerateDialog} onClose={() => setOpenGenerateDialog(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions sx={{ p: 2 }}>
          ...
          <Button onClick={handleGenerateSubmit} variant="contained" sx={{ bgcolor: '#3498db' }}>
            Generate
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={openEditDialog} onClose={() => setOpenEditDialog(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions sx={{ p: 2 }}>
          ...
          <Button onClick={handleEditSubmit} variant="contained" sx={{ bgcolor: '#f39c12' }}>
            Update
          </Button>
        </DialogActions>
      </Dialog>
        ...
        <DialogContent>
          <Alert severity="info" sx={{ mb: 3, mt: 2 }}>
            ...
            <Typography variant="body2" paragraph>
              This will generate professional PDF invoices for all companies with mapped order statements.
            </Typography>
          </Alert>
